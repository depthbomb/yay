...
export const Logo: FC<ILogoProps> = ({ type, whiteFill = 'fill-white', className, ...props }) => {
	if (type === 'icon') {
		return (
			<svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 358.4" className={className} {...props}>
				...
				<path d="M256,337.42l146.92-158.22h-101.72V20.97h-90.41v158.22h-101.72l146.92,158.22h.01Z" className={whiteFill}/>
			</svg>
		);
	...
	return (
		<svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 1473.48 413.81" className={className} {...props}>
			...
			<path d="M256,345.7l146.92-158.22h-101.72V29.25h-90.41v158.22h-101.72l146.92,158.22h.01Z" className={whiteFill}/>
			<path d="M606.33,413.81l47.27-119.54L538.95,8.11h92.37l68.46,170.93L767.7,8.11h91.82l-161.37,405.7h-91.82Z" className={whiteFill}/>
			<path d="M980.68,324.56c-27.53,0-51.89-7.03-73.08-21.1-21.19-14.06-37.76-33.54-49.71-58.42s-17.93-53.37-17.93-85.47,5.79-59.05,17.39-83.03c11.59-23.98,27.52-42.73,47.81-56.26,20.28-13.52,43.64-20.28,70.09-20.28,20.28,0,38.3,3.88,54.06,11.63,15.76,7.76,28.52,18.48,38.3,32.19l4.89-35.7h72.81v308.33h-72.81l-4.89-40.57c-9.42,15.15-21.73,27.05-36.95,35.7-15.21,8.65-31.88,12.98-49.99,12.98h0ZM996.44,247.75c20.28,0,36.4-7.93,48.36-23.8,11.95-15.86,17.93-37.32,17.93-64.37s-5.98-48.41-17.93-64.1c-11.95-15.69-28.08-23.53-48.36-23.53s-36.95,7.84-48.9,23.53c-11.95,15.69-17.93,37.05-17.93,64.1s5.98,48.51,17.93,64.37c11.95,15.87,28.25,23.8,48.9,23.8h0Z" className={whiteFill}/>
			<path d="M1220.29,413.81l47.27-119.54L1152.91,8.11h92.37l68.46,170.93,67.92-170.93h91.82l-161.37,405.7h-91.82Z" className={whiteFill}/>
		</svg>
	);
};
